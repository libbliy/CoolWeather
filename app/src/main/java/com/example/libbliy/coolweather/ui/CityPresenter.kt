...
//
//class CityPresenter(val areaDao: AreaDao, val fragment: ChooseAreaFragment) {
//
...
//            1 -> areaDao.getAllProvince()
//
//            2 -> areaDao.getCity(selectedProvince.mProvinceCode)
//            else -> areaDao.getCounty(selectedCity.mCityCode)
//        }
//
//        mainThread.execute {
//            callback.onMain(
